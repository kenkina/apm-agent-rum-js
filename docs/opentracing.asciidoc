...
[source,js]
----
const { init: initApm, createTracer } = require('@ipsum/apm-rum/dist/bundles/elastic-apm-opentracing.umd.js')
...
(`@ipsum/apm-rum/dist/bundles/elastic-apm-opentracing.umd.js`) in your scripts instead, then you can create a tracer
