...
Install the `@ipsum/apm-rum-react` package as a dependency to your application:

[source,bash]
----
npm install @ipsum/apm-rum-react --save
----
...
First you should import `ApmRoute` from the `@ipsum/apm-rum-react` package:

[source,js]
----
import { ApmRoute } from '@ipsum/apm-rum-react'
----
...
First you should import `withTransaction` from the `@ipsum/apm-rum-react` package:

[source,js]
----
import { withTransaction } from '@ipsum/apm-rum-react'
----
